...
insert into Example.T_DemoTable (Id, Message, Type, InsertDate, InsertUser) values (newid(), 'It is working!', '36a072b9-7216-4b99-bf8d-79730a4a1f37', getdate(), 'fritz@meier.ch')
